...
namespace SQLBuilder.Core.Repositories
{
    ...
    public class MySqlRepository : IRepository
    {
        ...
        {
            var result = 0;
            var builder = Sql.Insert<T>(() => entity, DatabaseType.MySQL, false, SqlIntercept);
            if (Transaction?.Connection != null)
            {
        ...
        {
            var result = 0;
            var builder = Sql.Delete<T>(DatabaseType.MySQL, SqlIntercept);
            if (Transaction?.Connection != null)
            {
        ...
        {
            var result = 0;
            var builder = Sql.Delete<T>(DatabaseType.MySQL, SqlIntercept).WithKey(entity);
            if (Transaction?.Connection != null)
            {
                result = Transaction.Connection.Execute(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
            }
        ...
        {
            var result = 0;
            var builder = Sql.Delete<T>(DatabaseType.MySQL, SqlIntercept).Where(predicate);
            if (Transaction?.Connection != null)
            {
                result = Transaction.Connection.Execute(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
            }
        ...
        public int Delete<T>(params object[] keyValues) where T : class
        {
            ...
            {
                var builder = Sql.Delete<T>(DatabaseType.MySQL, SqlIntercept).WithKey(keyValues);
                if (Transaction?.Connection != null)
                {
                    result = Transaction.Connection.Execute(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
                }
        ...
        {
            var result = 0;
            var builder = Sql.Update<T>(() => entity, DatabaseType.MySQL, false, SqlIntercept).WithKey(entity);
            if (Transaction?.Connection != null)
            {
                result = Transaction.Connection.Execute(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
            }
        ...
        {
            var result = 0;
            var builder = Sql.Update<T>(entity, DatabaseType.MySQL, false, SqlIntercept).Where(predicate);
            if (Transaction?.Connection != null)
            {
                result = Transaction.Connection.Execute(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
            }
        ...
        public T FindEntity<T>(params object[] keyValues) where T : class
        {
            ...
            var builder = Sql.Select<T>(databaseType: DatabaseType.MySQL, sqlIntercept: SqlIntercept).WithKey(keyValues);
            if (Transaction?.Connection != null)
            {
        ...
        {
            if (keyValues == null) return default(T);
            var builder = Sql.Select<T>(selector, DatabaseType.MySQL, SqlIntercept).WithKey(keyValues);
            if (Transaction?.Connection != null)
            {
                return Transaction.Connection.QueryFirstOrDefault<T>(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
            }
        ...
        {
            var builder = Sql.Select<T>(databaseType: DatabaseType.MySQL, sqlIntercept: SqlIntercept).Where(predicate);
            if (Transaction?.Connection != null)
            {
                return Transaction.Connection.QueryFirstOrDefault<T>(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
            }
        ...
        {
            var builder = Sql.Select<T>(selector, DatabaseType.MySQL, SqlIntercept).Where(predicate);
            if (Transaction?.Connection != null)
            {
                return Transaction.Connection.QueryFirstOrDefault<T>(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
            }
        ...
        {
            var builder = Sql.Select<T>(databaseType: DatabaseType.MySQL, sqlIntercept: SqlIntercept);
            if (Transaction?.Connection != null)
            {
        ...
        {
            var builder = Sql.Select<T>(selector, DatabaseType.MySQL, SqlIntercept);
            if (Transaction?.Connection != null)
            {
                return Transaction.Connection.Query<T>(builder.Sql, transaction: Transaction, commandTimeout: CommandTimeout).AsQueryable();
            }
        ...
        {
            var builder = Sql.Select<T>(selector, DatabaseType.MySQL, SqlIntercept).OrderBy(orderField, orderTypes);
            if (Transaction?.Connection != null)
            {
                return Transaction.Connection.Query<T>(builder.Sql, transaction: Transaction, commandTimeout: CommandTimeout).AsQueryable();
            }
        ...
        {
            var builder = Sql.Select<T>(selector, DatabaseType.MySQL, SqlIntercept).Where(predicate).OrderBy(orderField, orderTypes);
            if (Transaction?.Connection != null)
            {
                return Transaction.Connection.Query<T>(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout).AsQueryable();
            }
