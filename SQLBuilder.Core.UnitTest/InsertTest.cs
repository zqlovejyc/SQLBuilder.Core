...
namespace SQLBuilder.Core.UnitTest
{
    ...
    public class InsertTest
    {
        ...
        public void Test_Insert_01()
        {
            ...
            Assert.AreEqual("INSERT INTO [Base_UserInfo] ([Name],[Sex]) VALUES (@Parameter1,@Parameter2)", builder.Sql);
        ...
        public void Test_Insert_03()
        {
            ...
            Assert.AreEqual("INSERT INTO [Base_UserInfo] ([Id],[Sex],[Name],[Email]) VALUES (NULL,@Parameter1,@Parameter2,NULL)", builder.Sql);
            Assert.AreEqual(2, builder.Parameters.Count);
        }
        ...
        public void Test_Insert_04()
        {
            ...
            Assert.AreEqual("INSERT INTO [Base_Student] ([Name],[AccountId]) VALUES (@Parameter1,@Parameter2)", builder.Sql);
            Assert.AreEqual(2, builder.Parameters.Count);
        }
        ...
        public void Test_Insert_05()
        {
            ...
            Assert.AreEqual("INSERT INTO [Base_UserInfo] ([Sex],[Name]) VALUES (@Parameter1,@Parameter2)", builder.Sql);
            Assert.AreEqual(2, builder.Parameters.Count);
        }
        #endregion
        ...
        public void Test_Batch_Insert_01()
        {
            ...
            Assert.AreEqual("INSERT INTO \"Base_UserInfo\" (\"Name\",\"Sex\") SELECT :Parameter1,:Parameter2 FROM DUAL UNION ALL SELECT :Parameter3,:Parameter4 FROM DUAL", builder.Sql);
        ...
        public void Test_Batch_Insert_02()
        {
            ...
            Assert.AreEqual("INSERT INTO [Base_UserInfo] ([Name],[Sex]) VALUES (@Parameter1,@Parameter2),(@Parameter3,@Parameter4)", builder.Sql);
            Assert.AreEqual(4, builder.Parameters.Count);
        }
        ...
        public void Test_Batch_Insert_03()
        {
            ...
            Assert.AreEqual("INSERT INTO [Base_UserInfo] ([Id],[Sex],[Name],[Email]) VALUES (NULL,@Parameter1,@Parameter2,NULL),(NULL,@Parameter3,@Parameter4,NULL)", builder.Sql);
            Assert.AreEqual(4, builder.Parameters.Count);
        }
        ...
        public void Test_Batch_Insert_05()
        {
            ...
            Assert.AreEqual("INSERT INTO [Base_Class] ([UserId],[Name]) VALUES (@Parameter1,@Parameter2),(@Parameter3,@Parameter4)", builder.Sql);
            Assert.AreEqual(4, builder.Parameters.Count);
        }
