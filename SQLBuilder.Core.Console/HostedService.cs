    ...
    public class HostedService : IHostedService
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken) =>
            await _apmAgent.Tracer.CaptureTransaction("Console .Net Core Test", "background", async () =>
            {
                ...
                try
                {
                    var repository = new OracleRepository(@"Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=10.32.44.54)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=giteadev)));Persist Security Info=True;User ID=giteadev;Password=giteadev;");
