...
namespace SQLBuilder.Core.Repositories
{
    ...
    public class SqliteRepository : IRepository
    {
        ...
        {
            var result = 0;
            var builder = Sql.Insert<T>(() => entity, DatabaseType.SQLite, false, SqlIntercept, IsEnableFormat);
            if (Transaction?.Connection != null)
            {
        ...
        {
            var result = 0;
            var builder = Sql.Delete<T>(DatabaseType.SQLite, SqlIntercept, IsEnableFormat);
            if (Transaction?.Connection != null)
            {
        ...
        {
            var result = 0;
            var builder = Sql.Delete<T>(DatabaseType.SQLite, SqlIntercept, IsEnableFormat).WithKey(entity);
            if (Transaction?.Connection != null)
            {
                result = Transaction.Connection.Execute(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
            }
        ...
        {
            var result = 0;
            var builder = Sql.Delete<T>(DatabaseType.SQLite, SqlIntercept, IsEnableFormat).Where(predicate);
            if (Transaction?.Connection != null)
            {
                result = Transaction.Connection.Execute(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
            }
        ...
        public int Delete<T>(params object[] keyValues) where T : class
        {
            ...
            {
                var builder = Sql.Delete<T>(DatabaseType.SQLite, SqlIntercept, IsEnableFormat).WithKey(keyValues);
                if (Transaction?.Connection != null)
                {
                    result = Transaction.Connection.Execute(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
                }
        ...
        {
            var result = 0;
            var builder = Sql.Update<T>(() => entity, DatabaseType.SQLite, false, SqlIntercept, IsEnableFormat).WithKey(entity);
            if (Transaction?.Connection != null)
            {
                result = Transaction.Connection.Execute(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
            }
        ...
        {
            var result = 0;
            var builder = Sql.Update<T>(entity, DatabaseType.SQLite, false, SqlIntercept, IsEnableFormat).Where(predicate);
            if (Transaction?.Connection != null)
            {
                result = Transaction.Connection.Execute(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
            }
        ...
        public T FindEntity<T>(params object[] keyValues) where T : class
        {
            ...
            var builder = Sql.Select<T>(databaseType: DatabaseType.SQLite, sqlIntercept: SqlIntercept, isEnableFormat: IsEnableFormat).WithKey(keyValues);
            if (Transaction?.Connection != null)
            {
        ...
        {
            if (keyValues == null) return default(T);
            var builder = Sql.Select<T>(selector, DatabaseType.SQLite, SqlIntercept, IsEnableFormat).WithKey(keyValues);
            if (Transaction?.Connection != null)
            {
                return Transaction.Connection.QueryFirstOrDefault<T>(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
            }
        ...
        {
            var builder = Sql.Select<T>(databaseType: DatabaseType.SQLite, sqlIntercept: SqlIntercept, isEnableFormat: IsEnableFormat).Where(predicate);
            if (Transaction?.Connection != null)
            {
                return Transaction.Connection.QueryFirstOrDefault<T>(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
            }
        ...
        {
            var builder = Sql.Select<T>(selector, DatabaseType.SQLite, SqlIntercept, IsEnableFormat).Where(predicate);
            if (Transaction?.Connection != null)
            {
                return Transaction.Connection.QueryFirstOrDefault<T>(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout);
            }
        ...
        {
            var builder = Sql.Select<T>(databaseType: DatabaseType.SQLite, sqlIntercept: SqlIntercept, isEnableFormat: IsEnableFormat);
            if (Transaction?.Connection != null)
            {
        ...
        {
            var builder = Sql.Select<T>(selector, DatabaseType.SQLite, SqlIntercept, IsEnableFormat);
            if (Transaction?.Connection != null)
            {
                return Transaction.Connection.Query<T>(builder.Sql, transaction: Transaction, commandTimeout: CommandTimeout).AsQueryable();
            }
        ...
        {
            var builder = Sql.Select<T>(selector, DatabaseType.SQLite, SqlIntercept, IsEnableFormat).OrderBy(orderField, orderTypes);
            if (Transaction?.Connection != null)
            {
                return Transaction.Connection.Query<T>(builder.Sql, transaction: Transaction, commandTimeout: CommandTimeout).AsQueryable();
            }
        ...
        {
            var builder = Sql.Select<T>(selector, DatabaseType.SQLite, SqlIntercept, IsEnableFormat).Where(predicate).OrderBy(orderField, orderTypes);
            if (Transaction?.Connection != null)
            {
                return Transaction.Connection.Query<T>(builder.Sql, builder.DynamicParameters, Transaction, commandTimeout: CommandTimeout).AsQueryable();
            }
        ...
        {
            var builder = Sql.Select<T>(databaseType: DatabaseType.SQLite, isEnableFormat: IsEnableFormat);
            ...
            var sql = $"SELECT COUNT(1) AS Total FROM ({builder.Sql}) AS T;SELECT * FROM ({builder.Sql}) AS X {orderField} LIMIT {pageSize} OFFSET {(pageSize * (pageIndex - 1))};";
        ...
        {
            var builder = Sql.Select<T>(databaseType: DatabaseType.SQLite, isEnableFormat: IsEnableFormat).Where(predicate);
            if (!orderField.IsNullOrEmpty())
            {
                if (orderField.Contains(@"(/\*(?:|)*?\*/)|(\b(ASC|DESC)\b)", RegexOptions.IgnoreCase))
                    orderField = $"ORDER BY {orderField}";
        ...
        {
            var builder = Sql.Select<T>(selector, DatabaseType.SQLite, isEnableFormat: IsEnableFormat).Where(predicate);
            if (!orderField.IsNullOrEmpty())
            {
                if (orderField.Contains(@"(/\*(?:|)*?\*/)|(\b(ASC|DESC)\b)", RegexOptions.IgnoreCase))
                    orderField = $"ORDER BY {orderField}";
        ...
        public (IEnumerable<T> list, long total) FindList<T>(string sql, object parameter, string orderField, bool isAscending, int pageSize, int pageIndex)
        {
            ...
            sql = $"SELECT COUNT(1) AS Total FROM ({sql}) AS T;SELECT * FROM ({sql}) AS X {orderField} LIMIT {pageSize} OFFSET {(pageSize * (pageIndex - 1))};";
            sql = SqlIntercept?.Invoke(sql, parameter) ?? sql;
            if (Transaction?.Connection != null)
            {
