...
namespace SQLBuilder.Core.Repositories
{
    ...
    public abstract class BaseRepository
    {
        ...
        /// <param name="selector">选择指定列，null选择全部</param>
        /// <returns>返回集合</returns>
        public virtual IQueryable<T> IQueryable<T>(Expression<Func<T, object>> selector) where T : class
        {
        ...
        /// <returns>返回集合</returns>
        public virtual IQueryable<T> IQueryable<T>(Expression<Func<T, object>> selector, Expression<Func<T, object>> orderField, params OrderType[] orderTypes) where T : class
        {
        ...
        /// <param name="predicate">查询条件</param>
        /// <returns>返回集合</returns>
        public virtual IQueryable<T> IQueryable<T>(Expression<Func<T, object>> selector, Expression<Func<T, bool>> predicate) where T : class
        {
            var builder = Sql.Select<T>(selector, DatabaseType, SqlIntercept, IsEnableFormat).Where(predicate);
            return Query<T>(builder).AsQueryable();
        }
        ...
        /// <param name="orderTypes">排序类型，默认正序排序</param>
        /// <returns>返回集合</returns>
        public virtual IQueryable<T> IQueryable<T>(Expression<Func<T, object>> selector, Expression<Func<T, bool>> predicate, Expression<Func<T, object>> orderField, params OrderType[] orderTypes) where T : class
        {
        ...
        /// <param name="selector">选择指定列，null选择全部</param>
        /// <returns>返回集合</returns>
        public virtual async Task<IQueryable<T>> IQueryableAsync<T>(Expression<Func<T, object>> selector) where T : class
        {
            var builder = Sql.Select<T>(selector, DatabaseType, SqlIntercept, IsEnableFormat);
            return (await QueryAsync<T>(builder)).AsQueryable();
        }
        ...
        /// <param name="orderTypes">排序类型，默认正序排序</param>
        /// <returns>返回集合</returns>
        public virtual async Task<IQueryable<T>> IQueryableAsync<T>(Expression<Func<T, object>> selector, Expression<Func<T, object>> orderField, params OrderType[] orderTypes) where T : class
        {
            var builder = Sql.Select<T>(selector, DatabaseType, SqlIntercept, IsEnableFormat).OrderBy(orderField, orderTypes);
            return (await QueryAsync<T>(builder)).AsQueryable();
        }
        ...
        /// <param name="predicate">查询条件</param>
        /// <returns>返回集合</returns>
        public virtual async Task<IQueryable<T>> IQueryableAsync<T>(Expression<Func<T, object>> selector, Expression<Func<T, bool>> predicate) where T : class
        {
            var builder = Sql.Select<T>(selector, DatabaseType, SqlIntercept, IsEnableFormat).Where(predicate);
            return (await QueryAsync<T>(builder)).AsQueryable();
        }
        ...
        /// <param name="orderTypes">排序类型，默认正序排序</param>
        /// <returns>返回集合</returns>
        public virtual async Task<IQueryable<T>> IQueryableAsync<T>(Expression<Func<T, object>> selector, Expression<Func<T, bool>> predicate, Expression<Func<T, object>> orderField, params OrderType[] orderTypes) where T : class
        {
            var builder = Sql.Select<T>(selector, DatabaseType, SqlIntercept, IsEnableFormat).Where(predicate).OrderBy(orderField, orderTypes);
            return (await QueryAsync<T>(builder)).AsQueryable();
        }
